...
const { getChatMessages } = require('./api/message/get-messages.js')
const { authenticate } = require('./middlewares/authenticate.js')
const { getMessages } = require('./api/message/check-messages.js')
...
app.get('/admin/check-messages/:userId', authenticate, getMessages)

app.get('/get-messages/:userId', authenticate, getChatMessages)
